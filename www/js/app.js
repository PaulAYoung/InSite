...
},{"./audioPlayer.tag":18,"./blueimp-gallery":19,"./controller":20,"./controls.tag":21,"./geoQuerier.js":24,"./itemDetail.tag":26,"./listView.tag":27,"./localground_connector":28,"./map.tag":29,"./tour.tag":34,"./welcome.tag":36,"bootstrap":2,"jquery":15,"leaflet":16,"riot":17}],2:[function(require,module,exports){
...
var riot = require('riot');
riot.tag('audioplayer', '<audio name="player" if="{this.display}"> <source riot-src="{ this.item.file_path }"> </audio> <div class="audio-details"> { item.name } </div>', function(opts) {
...
},{"riot":17}],19:[function(require,module,exports){
/*
...
},{"./dataFilter":23,"./geoSort.js":25,"./simpleSet":32,"./tourSort.js":35,"riot":17}],21:[function(require,module,exports){
var riot = require('riot');
riot.tag('controls', '<div class="navbar navbar-inverse navbar-fixed-top container-fluid controls-container" role="navigation"> <div class="row"> <div class="insite-menu-button dropdown"> <button type="button" class="btn btn-default insite-button" data-toggle="dropdown"> <img width="60" src="fonts/InSite_logo_web.png"> </button> <ul class="dropdown-menu insite-menu"> <li><a href="index.html">Home</a></li> <li><a href="#itemDetail/{opts.aboutMarkerID}">About</a></li> </ul> </div> <div class="nav-buttons"> <a href="#Map"><img class="mapIcon" src="fonts/noun_24173_cc.svg"></img></a> <a href="#List"><span style="color:white;" class="glyphicon glyphicon-list"></span></a> <a href="#"><img class="locateIcon" src="fonts/noun_40972_cc.svg"></img></a> <div class="insite-menu-button dropdown"> <button class="btn btn-default insite-button" data-toggle="dropdown"> <span>Tours</span> </button> <ul class="dropdown-menu insite-menu"> <li each="{ opts.tours }"> <a onclick="{ parent.startTour }" href=""> { name } </a> </li> </ul> </div> </div> <div class="dropdown float-right"> <button type="button" class="btn btn-default insite-button" data-toggle="dropdown"> <span class="glyphicon glyphicon-search"></span> </button> <ul class="dropdown-menu insite-menu"> <li each="{ opts.highlightedFilters }" onclick="{ parent.applyFilter }" > <a href=""> { name } </a> </li> <li> <div class="form-group"> <form onsubmit="{ search }"> <input type="text" name="searchbox" class="form-control" placeholder="Search"> <button type=submit class="btn btn-default">Submit</button> </form> </div> </li> </ul> </div> </div> <div if="{ message }" class="message-area"> { message } </div> </div>', function(opts) {
        var controller = opts.controller;
...
},{"riot":17}],22:[function(require,module,exports){
...
var riot = require('riot');
riot.tag('itemdetail', '<div id="itemDetail" if="{this.display}"> <div class="panel panel-default">  <div class="panel-heading" id="title"> <h3 style="margin-top: 0px">{item.name} </h3> </div> <div class="panel-body"> <div name="mapThumbnail"> </div> <div id="description"> <p>{item.description}</p> </div> </div>  <div id="audioList" if="{ this.item.audio_array }">  <ul class="list-group"> <li each="{this.getAudio()}" onclick="{parent.playAudio}" class="list-group-item audioItem">  <div style="float:left;clear:both;"> <span class="glyphicon glyphicon-volume-up"></span> </div> <div style="margin-left:20px;"> <strong class="audio-name">{name} - </strong> <span class="attribution" style="font-size:16px;">{attribution}</span> <p>{description}</p> </div> </li> </ul> </div> </div>  <div show="{ item.photo_array != null }">  <div id="blueimp-gallery-carousel" name="gallery" class="blueimp-gallery blueimp-gallery-carousel blueimp-gallery-controls"> <div class="slides" name="slides"></div> <h3 class="title"></h3> <a class="prev">‹</a> <a class="next">›</a> <a class="play-pause"></a> <ol class="indicator"></ol>  <div class="modal fade"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <button type="button" class="close" aria-hidden="true">&times;</button> <h4 class="modal-title"></h4> </div> <div class="modal-body next"></div> <div class="modal-footer"> <button type="button" class="btn btn-default pull-left prev"> <i class="glyphicon glyphicon-chevron-left"></i> Previous </button> <button type="button" class="btn btn-primary next"> Next <i class="glyphicon glyphicon-chevron-right"></i> </button> </div> </div> </div> </div> </div> </div> <div id="photo-description">{ photoDescription }</div>  <div id="tags"> <strong>Tags: </strong> <span style="color:#337ab7;" each="{ getTags() }" class=item-tag onclick="{ parent.setFilter }">{ tag } </span> </div> </div>', function(opts) {
        this.display=false;
        ...
        this.onSlide = function(index, slide) {
...
},{"jquery":15,"riot":17}],27:[function(require,module,exports){
var riot = require('riot');
riot.tag('listview', '<ul class="list-group insite-listview" if="{this.display}"> <li each="{ this.items }" if="{ description || photo_array || audio_array }" class="list-group-item" onclick="{parent.selectItem}"> <item> </item> </li> </ul>', function(opts) {
        var L = require('leaflet');
        this.display=false;
        this.items = [];
        var controller = opts.controller;
        ...
        this.distanceTo = function(lat, lon) {
        ...
        this.getPhoto = function(photo_array) {
...
riot.tag('item', '<div class="container-fluid"> <div class="row"> <div class="col-xs-3 col-md-3"> <div class="thumbnail-div"> <img class="thumbnail-photo" riot-src="{ parent.getPhoto(photo_array) }" > </div> </div> <div class="col-xs-9 col-md-9"> <div class="row description-row"> <div class="col-xs-12 col-md-12"> <h4>{ name }</h4> <span if="{ this.description }">{ parent.shortenText(description, 50) }</span> </div> <div class="col-xs-9 col-md-9">  <span if="{ this.description == false }"><br><br></span> <span if="{ this.audio_array }" class="glyphicon glyphicon-volume-up">x{this.audio_array.length }</span> </div> <div class="col-xs-3 col-md-3">  <span if="{ this.description == false }"><br><br></span> <span class="distance">{ parent.distanceTo(geometry.coordinates[1], geometry.coordinates[0]) }</span> </div> </div> </div> </div> </div>', function(opts) {
...
},{"./convertToUSDistance":22,"./shortenText":31,"leaflet":16,"riot":17}],28:[function(require,module,exports){
var $ = require('jquery');
...
var riot = require('riot');
riot.tag('map', '<div if="{ this.display }"> <div name="mapArea" class="mapArea"></div> <div name="legend" class="map-legend dropup"> <button type="button" class="btn btn-default insite-button" data-toggle="dropdown"> Legend </button> <ul class="dropdown-menu map-legend-items"> <li each="{ tag, i in opts.tagStyles }"> <svg height="20" width="20"> <circle cx="10" cy="10" r="10" class="insite-map-marker {tag}"></circle> </svg> { tag }</li> </li> <li> <svg height="20" width="20"> <circle cx="10" cy="10" r="10" class="insite-map-marker"></circle> </svg> other</li> </li> </ul> </div> </div>', function(opts) {
        this.display=false;
        var L = require('leaflet');
...
},{"./setViewbyLocation":30,"./shortenText":31,"./simpleSet.js":32,"./stringMatcher":33,"jquery":15,"leaflet":16,"riot":17}],30:[function(require,module,exports){
...
riot.tag('tour', '<div if="{ this.display }" class="tourstop-info"> <h4 if="{ tour }" class="tour-title">{ tour.name } Tour</h4> <span onclick="{ this.itemDetailURL }">{ this.displayTourStopNumber()}: { this.displayTourStopName() } - { this.distanceTo() }</span> <div style="float:right;position:relative;" onclick="{ this.endTour }"> <span class="glyphicon glyphicon-remove"></span> <span>Exit Tour</span> </div> <div style="position:relative;float:left;clear:both;width:100%;margin:.5em;"> <div style="position:relative;float:left;" onclick="{ this.back }"> <span class="glyphicon glyphicon-chevron-left" ></span> <span>Back</span> </div> <div style="position:relative;float:right;" onclick="{ this.next }"> <span>Next</span> <span class="glyphicon glyphicon-chevron-right" ></span> </div> </div> </div>', function(opts) {
        ...
        this.displayTourStopNumber = function() {
            if (controller.markers !== null) {return 'Stop '+String(self.tourIndex+1);}
            else {return "";}
        }.bind(this);

        this.displayTourStopName = function() {
...
},{"./convertToUSDistance":22,"./simpleSet.js":32,"leaflet":16,"riot":17}],35:[function(require,module,exports){
...
var riot = require('riot');
riot.tag('welcome', '<div id="welcome-header" if="{ this.display }"> <h1 style="margin-bottom:5px;">{ opts.appTitle }</h1> <p style="font-size:16px;">{ opts.appDescription }</p> </div> <div if="{ this.display }" onclick="{ this.hideWelcome }" id="exit-welcome"></div> <div id="welcome-footer" if="{ this.display }"> <div id="welcome-footer-content"> <button class="btn btn-primary tour-button" onclick="{ this.startTour }" type="submit">Take a Tour</button><span style="margin:5px;">or</span><button class="btn btn-primary tour-button" onclick="{ this.fullMap }" type="submit">Explore Full Map</button> </div> </div>', function(opts) {
        var controller = opts.controller;
        var $ = require('jquery');
        var self = this;
